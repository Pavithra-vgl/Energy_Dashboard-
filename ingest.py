...
def run_ingestion(db: Session):
    region = os.getenv("SMARD_REGION", "DE")
    resolution = os.getenv("SMARD_RESOLUTION", "hour")

    metric_filters = {
        "load": os.getenv("SMARD_FILTER_LOAD", "").strip(),
        "wind": os.getenv("SMARD_FILTER_WIND", "").strip(),
        "solar": os.getenv("SMARD_FILTER_SOLAR", "").strip(),
    }
